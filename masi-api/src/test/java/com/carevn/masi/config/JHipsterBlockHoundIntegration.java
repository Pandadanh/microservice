package com.carevn.masi.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.carevn.masi.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.carevn.masi.security.DomainUserDetailsService", "createSpringSecurityUser");
