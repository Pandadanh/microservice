...
import com.masi.employee.service.JobHistoryService;
...
/**
 * REST controller for managing {@link com.masi.employee.domain.JobHistory}.
 */
@RestController
...
public class JobHistoryResource {
    ...
    private static final String ENTITY_NAME = "masiEmployeeJobHistory";
