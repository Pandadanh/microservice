package com.masi.employee.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.masi.employee.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.masi.employee.security.DomainUserDetailsService", "createSpringSecurityUser");
