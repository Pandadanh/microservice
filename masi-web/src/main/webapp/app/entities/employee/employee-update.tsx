  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="masiWebApp.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="masiWebApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('masiWebApp.employee.firstName')}
              ...
              <UncontrolledTooltip target="firstNameLabel">
                <Translate contentKey="masiWebApp.employee.help.firstName" />
              </UncontrolledTooltip>
              <ValidatedField
                label={translate('masiWebApp.employee.lastName')}
                id="employee-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              />
              <ValidatedField label={translate('masiWebApp.employee.email')} id="employee-email" name="email" data-cy="email" type="text" />
              <ValidatedField
                label={translate('masiWebApp.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('masiWebApp.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('masiWebApp.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('masiWebApp.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('masiWebApp.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('masiWebApp.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
