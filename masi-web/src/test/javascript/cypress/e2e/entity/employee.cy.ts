...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      ...
      cy.get(`[data-cy="email"]`).type('Lilyan_Schroeder40@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Lilyan_Schroeder40@gmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('nor calm as');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'nor calm as');

      cy.get(`[data-cy="hireDate"]`).type('2024-04-04T16:11');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-04-04T16:11');
